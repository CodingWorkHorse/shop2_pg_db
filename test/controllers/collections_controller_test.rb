...
class CollectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collection" do
    assert_difference('Collection.count') do
      post collections_url, params: { collection: { access_code: @collection.access_code, title: @collection.title, user: @collection.user } }
    end
  ...
  test "should update collection" do
    patch collection_url(@collection), params: { collection: { access_code: @collection.access_code, title: @collection.title, user: @collection.user } }
